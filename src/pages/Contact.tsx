    ...
    <section id="contact" className='border'>
      <div ref={contactRef} className="w-full h-screen flex justify-center items-center bg-[#121212] ">
        <div className="relative border rounded-2xl w-4/5 h-3/5 flex flex-col drop-shadow-[0_0_4px_rgba(255,255,255,0.5)]">
          ...
          <div className="flex-1 flex w-1/2 justify-evenly items-center text-[#F3F3F3] ">
            <Mail size={36} className="drop-shadow-[0_0_6px_rgba(203,161,53,1)] hover:drop-shadow-[0_0_15px_rgba(235,235,235,2)] hover:scale-110 transition-all duration-300"/>
            <Phone size={36} className="drop-shadow-[0_0_6px_rgba(203,161,53,1)] hover:drop-shadow-[0_0_15px_rgba(235,235,235,2)] hover:scale-110 transition-all duration-300"/>
            <Github size={36} className="drop-shadow-[0_0_6px_rgba(203,161,53,1)] hover:drop-shadow-[0_0_15px_rgba(235,235,235,2)] hover:scale-110 transition-all duration-300"/>
            <Instagram size={36} className="drop-shadow-[0_0_6px_rgba(203,161,53,1)] hover:drop-shadow-[0_0_15px_rgba(235,235,235,2)] hover:scale-110 transition-all duration-300"/>
            <Instagram size={36} className="drop-shadow-[0_0_6px_rgba(203,161,53,1)] hover:drop-shadow-[0_0_15px_rgba(235,235,235,2)] hover:scale-110 transition-all duration-300"/>
          </div>
          <div className="absolute border rounded-2xl w-2/5 h-2/3 top-1/2 -translate-y-1/2 left-1/2 translate-x-10 bg-[#1E1E1E] text-[#F3F3F3] border-[#2E2E2E]">
